  ...
  return (
    <div className="col" style={{ gap: 14 }}>
      <div className="alert info">
        ...
        <div>
          <div className="ttl">这是一个 Worker 兼容层</div>
          superglm 暴露 Claude 风格的模型别名，方便 Claude Code 直连。<b>这并不代表上游就是 Anthropic</b>——所有别名都会被解析到你在「方案」里配置的真实上游模型。
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="card-b col" style={{ gap: 14 }}>
          <div className="muted" style={{ fontSize: 12.5, maxWidth: 760 }}>
            部分 Claude Code 请求会带上一行 <code className="mono">x-anthropic-billing-header</code>，其中 <code className="mono">cch</code> 值在每次会话都会变。直接转发到第三方上游会破坏 <b>前缀缓存稳定性</b>。superglm 可以在路由前剥离或规范化这一行。
          </div>
