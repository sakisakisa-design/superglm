...
const PAGE_META = {
  overview:  { crumb: 'gateway / overview',                  h: '概览',                desc: '云端网关运行状态、请求量与最近活动。' },
  setup:     { crumb: 'gateway / setup-wizard',              h: '配置向导',            desc: '四步把 Claude Code 接到 superglm Worker。' },
    ...
    <div className={`app ${t.density === 'compact' ? 'dense' : ''}`}>
      ...
      <div className="topbar">
        <div className="brand">
          ...
          <div className="brand-name">superglm<span className="sub mono">worker</span></div>
        </div>
        ...
        <span className="chip mono"><Icon name="server" size={11}/> {window.SUPERDS_BASE_URL || window.location.origin}</span>
